...
import com.daliedu.adapter.ProblemListAdapter;
import com.daliedu.app.AppContext;
import com.daliedu.entity.Problem;
...
//        });
    ...
    private class GetDataTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
            	String result = null;
            	result = HttpConnectUtil.httpGetRequest((AppContext) AnswerMainActivity.this.getApplication(), params[0]);
            	return result;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
		...
		new Thread(){
			public void run() {
				try
				{
					...
					String result = HttpConnectUtil.httpGetRequest((AppContext) AnswerMainActivity.this.getApplication(), url);
					LinkedList<Problem> list = parseJson(result);
