...
import com.daliedu.adapter.MyExpandableAdapter2;
...
public class QuestionFromCourseActivity extends Activity{
	...
	private class GetMyLessonThread extends Thread
	{
		...
		public void run() {
			// TODO Auto-generated method stub
			try{
				String result = HttpConnectUtil.httpGetRequest((AppContext) QuestionFromCourseActivity.this.getApplication(), Constant.DOMAIN_URL+"mobile/myLessons?stuId="+id);
