...
import com.daliedu.adapter.CourseDetailListAdapter;
import com.daliedu.adapter.MyCourseListAdapter;
...
public class ClassDetailActivity extends Activity implements OnClickListener{
	...
	private class GetMyLessonThread extends Thread
	{
		...
		public void run() {
			// TODO Auto-generated method stub
			try{
				String result = HttpConnectUtil.httpGetRequest((AppContext) ClassDetailActivity.this.getApplication(), Constant.DOMAIN_URL+"mobile/findFreeClass?gid="+gid);
