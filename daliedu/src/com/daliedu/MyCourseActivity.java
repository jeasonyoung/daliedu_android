...
import com.daliedu.dao.UserClassDao;
import com.daliedu.entity.UserClass;
...
public class MyCourseActivity extends BaseActivity implements OnClickListener {
			...
			try {
				if (!isLocalLogin) {
					String result = HttpConnectUtil.httpGetRequest(
							(AppContext) MyCourseActivity.this.getApplication(),
	...
	private class ChildClickListener implements OnChildClickListener {
		...
		public boolean onChildClick(ExpandableListView parent, View v,
			...
			if(StringUtils.isEmpty(MyCourseActivity.this.classDetail[groupPosition][childPosition])||
					MyCourseActivity.this.classDetail[groupPosition][childPosition].equals("[]")){
				Toast.makeText(MyCourseActivity.this, "此课程暂无数据", Toast.LENGTH_SHORT)
				.show();
				return true;
			}
