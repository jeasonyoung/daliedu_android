...
public class QuestionPaperInfoActivity extends Activity implements OnClickListener{
	...
	private class GetQuestionListThread extends Thread
	{
		...
		public void run() {
			...
			try{
				String result = HttpConnectUtil.httpGetRequest((AppContext) QuestionPaperInfoActivity.this.getApplication(), Constant.DOMAIN_URL+"mobile/questionListofPaper?paperid="+paperid);
				//解析result
