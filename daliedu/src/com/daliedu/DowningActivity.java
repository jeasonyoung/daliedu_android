...
import com.daliedu.adapter.DowningListAdapter;
import com.daliedu.dao.CourseDao;
import com.daliedu.downloader.SmartFileDownloader;
import com.daliedu.entity.DowningCourse;
import com.daliedu.service.DownloadService;
		...
		public void run() {
			try {
				...
				if (conn.getResponseCode() == 200) {
					...
					if(!FileUtil.checkSDCard(fileSize)){
						Message errorMsg = handler.obtainMessage();
						errorMsg.what = -4;
						errorMsg.obj = "内存卡空间不够";
						handler.sendMessage(errorMsg);
						return;
					}
